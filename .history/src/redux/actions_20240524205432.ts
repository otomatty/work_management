import { Schedule, WorkRecord, Teacher } from "../types";
import { getTeachers } from "../firebase/teachers/teachers";
...
export const fetchTeachersSuccess = (teachers: Teacher[]) => ({
  ...
  return async (dispatch: any) => {
    ...
    try {
      ...
      if (error instanceof Error) {
        ...
        dispatch(fetchTeachersFailure("An unknown error occurred"));
      }
    }
  };
};
