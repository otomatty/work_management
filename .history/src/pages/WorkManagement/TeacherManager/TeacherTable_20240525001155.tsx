...
import TimeFormatToggle from "../../../components/atoms/TimeFormatToggle/TimeFormatToggle"; // New import
...
const TeacherTable: React.FC<Props> = ({
  ...
  const [timeFormat, setTimeFormat] = useState<"minutes" | "hours">("minutes"); // Added
  ...
  return (
    <>
      <TimeFormatToggle format={timeFormat} onToggle={setTimeFormat} />{" "}
      {/* Added */}
      <Table>
        <thead>
          <tr>
